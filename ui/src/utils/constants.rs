...
// Fill with data from https://www.stationx.net/common-ports-cheOat-sheet/
...
pub const ALL_COMMON_PORTS: [(Port, &str, &str); ALL_COMMON_PORTS_LENGHT] = [
    ...
    (514, "syslog", "Syslog Protocol, for collecting and organizing all of the log files sent from the various devices on a network"),
    ...
    (4444, "Blaster", "Possibly computer worm"),
